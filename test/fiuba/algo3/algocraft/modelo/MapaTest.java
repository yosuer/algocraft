...
public class MapaTest {
	...
	public void test04_DefinirEspaciosVaciosEnElMapa() {
		Mapa mapa = new Mapa(40, 40);
		ObstaculoTerrestre obstaculoTerrestre = new ObstaculoTerrestre();
	...
	public void test08_CrearUnMapaConRecursosPredeterminados() {
		...
		Assert.assertEquals(mapa.getElemento(46, 46, 0).nombre(), "Tierra");
	...
	public void test09_AlIniciarElMapaSePuedeRecorrerTodasLasPosiciones1() {
		...
		camino = mapa.getHojaDeRuta(new Posicion(5, 5, 0),
				new Posicion(8, 8, 0));
	...
	public void test10_AlIniciarElMapaSePuedeRecorrerTodasLasPosiciones2() {
		...
		Collection<Posicion> camino = mapa.getHojaDeRuta(new Posicion(5, 5, 0),
				new Posicion(7, 7, 0));
		Assert.assertEquals(3, camino.size());

		camino = mapa.getHojaDeRuta(new Posicion(20, 20, 0), new Posicion(14,
				14, 0));
	...
	public void test11_CaminoMinimoConObstaculosEnElMapa() {
		...
		Collection<Posicion> camino = mapa.getHojaDeRuta(
				new Posicion(1, 10, 0), new Posicion(3, 8, 0));
	...
	public void test18_ObtenerUnaPosicionDisponibleProximaAOtra2Borde() {
		...
		Assert.assertEquals(new Posicion(1, 2, 0),
				mapa.getPosicionProxima(new Posicion(2, 2, 0)));
	}
