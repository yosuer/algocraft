...
import fiuba.algo3.algocraft.controlador.acciones.CrearUnidad;
...
public class VistaCriadero extends VistaIElemento {
	...
	public VistaCriadero() {
		...
		this.armarImagen();
		this.btnCrearZergMineral = new Boton("ZergMineral", new CrearEdificio(new ZergMineral()));
		this.btnCrearExtractor = new Boton("Extractor", new CrearEdificio(new Extractor()));
		this.btnCrearReservaDeReproduccion = new Boton("ReservaReproduccion",new CrearEdificio(new ReservaDeReproduccion()));
		this.btnCrearGuaridaDeHidralisco = new Boton("GuaridaHidralisco",new CrearEdificio(new GuaridaDeHidralisco()));
		this.btnCrearEspiral = new Boton("Espiral", new CrearEdificio(new Espiral()));
